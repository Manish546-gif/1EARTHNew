      ...
      {isMobile ? (
        ...
        <>
          ...
          <img
            ...
            src={img3}
            alt="Top right overlay image"
            className="absolute z-5 top-[20%] right-[5%] w-[220px] h-[150px] md:top-[100%] md:w-[180px] md:h-[120px]"
          />
          ...
          <img
            ...
            src={img4}
            alt="Bottom left overlay image"
            className="absolute z-5 bottom-[20%] left-[5%] w-[260px] h-[140px] md:-bottom-[75%] md:w-[210px] md:h-[110px]"
          />
          ...
          <img
            ...
            src={img5}
            alt="Bottom right overlay image"
            className="absolute z-5 bottom-[20%] right-[5%] w-[260px] h-[140px] md:-bottom-[75%] md:w-[210px] md:h-[110px]"
          />
          ...
          <img
            ...
            src={img6}
            alt="Center bottom overlay image"
            className="absolute z-5 bottom-[10%] left-[40%] w-[180px] h-[130px] md:-bottom-[100%] md:w-[150px] md:h-[100px]"
          />
        </>
      )}
    </section>

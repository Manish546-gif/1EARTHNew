        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12 lg:gap-16">
          <div className="flex-shrink-0 md:w-3/11 ">
            <div className="text-center  lg:text-left">
              <h2 className="text-6xl lg:text-7xl  overflow-hidden text-black ">
          ...
          <div className="flex-1 flex flex-col lg:flex-row gap-22 lg:gap-26">
            <div className="flex flex-col items-center lg:items-start">
              <div className="w-64  h-64 lg:w-102 lg:h-102 mb-6 overflow-hidden">
                <img data-scroll data-scroll-speed='-0.05' src={img1} alt="" className="w-full h-full object-cover" />
              </div>

              <div className="text-center lg:text-left w-full">
                <h3 className="text-xl lg:text-2xl   text-black uppercase tracking-wide mb-2">
                  SHREYASH TARAWADE
                </h3>
            ...
            <div className="flex flex-col items-center lg:items-start">
              <div  className="w-64  h-64 lg:w-102 lg:h-102 mb-6 overflow-hidden">
                <img data-scroll data-scroll-speed='-0.05' src={img2} alt="" className="w-full h-full object-cover" />
              </div>
